...
urlpatterns = [
   ...
   # تعديل URL واحد لعرض المخزون وإضافة عنصر جديد
    ...
    path('create_payment/<int:reserve_id>/', views.create_payment_with_patient, name='create_payment_with_patient'),
    path('get_service_price/<int:service_id>/', views.get_service_price, name='get_service_price'),
  ...
  #  path('payment_inventory/create/', views.create_payment_inventory, name='create_payment_inventory'),
   # path('payment_inventories/', views.payment_inventory_list, name='payment_inventory_list'),
    ...
    path('register-used-item/', views.register_used_item, name='register_used_item'),
    path('edit-used-item/<int:item_id>/', views.edit_used_item, name='edit_used_item'),
    path('delete-used-item/<int:item_id>/', views.delete_used_item, name='delete_used_item'),
]